"""
    ...
    This script computes the the CBF based on equivariances. Only the explicitly computed points are computed in parallel. 
    Note: This script runs faster than its parallelized version.
