...
if __name__ == '__main__':
    ...
    # some parameters
    cbf_file_name = "cbf_inner_circle_partial.json"
    ...
    domain_lower_bound_complete = np.array([-25,-0.1,-np.pi])
    domain_upper_bound_complete = np.array([25,0.1,np.pi])
    ...
    # Default value of the CBF in the terminal set
    default_cbf_value = h(np.array([-2*turning_radius, 0, 0]))
    ...
    cbfModule_complete.radius = radius
    cbfModule_complete.turning_radius = turning_radius
