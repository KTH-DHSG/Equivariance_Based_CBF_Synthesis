...
if __name__ == '__main__':
    ...
    cbf_file_name = "s1_cbfm_equi.json"

    # create a dynamic system
    x0 = np.array([0,0])
    u_min = np.array([-2,-2])   # [minimum speed, minimum steering angle] in [m/s, rad/s]
    ...
    domain_lower_bound_partial = np.array([-15,0])
    domain_upper_bound_partial = np.array([0.1,0])
