...
# Parameters
cbf_file_name = '2025-06-17_18-53-34_cbf_ellipse.json'
...
# Replace all values < -cbf_lower_cutoff with -cbf_lower_cutoff for better visualization
cbf_lower_cutoff = -3  # Lower cut-off value for CBF visualization
cbf_values[cbf_values < cbf_lower_cutoff] = cbf_lower_cutoff
...
contour = ax2.contourf(X_slice, Y_slice, cbf_slice, levels=10, cmap=color_map, norm=norm)
