...
# Parameters
cbf_file_name = '2025-06-17_18-01-57_cbf_straight_line_complete.json'
...
domain_to_plot = [-15, 15, -5, 5] # [x_min, x_max, y_min, y_max]
...
x_red = np.linspace(domain_to_plot[0], domain_to_plot[1], 500)  # adjust range as needed
