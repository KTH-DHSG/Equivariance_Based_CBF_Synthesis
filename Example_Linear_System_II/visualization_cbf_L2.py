...
cbf_file_name = '2025-05-21_17-16-50_cbf_linear_system_2.json'
...
norm = mcolors.Normalize(vmin=cbf_values.min(), vmax=cbf_values.max())
...
# Add CBF contours
contour_levels = list(range(-1, 4, 1))
...
# plt.contourf(x_obstacle_grid, y_obstacle_grid, H_values, levels=[-np.inf, 0], colors='gray', alpha=0.5)  # plot the obstacle with thicker lines
