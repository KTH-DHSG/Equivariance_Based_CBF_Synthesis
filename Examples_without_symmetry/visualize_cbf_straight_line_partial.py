...
# Parameters
cbf_file_name = '2025-06-17_16-41-39_cbf_straight_line_partial.json'
cbf_folder_name = r'Examples_without_symmetry/Data_cbf_partial'

orientation_value = -np.pi  # Orientation angle in radians (first plot)
...
domain_to_plot = [-15, 15, -0.1, 0.1] # [x_min, x_max, y_min, y_max]
