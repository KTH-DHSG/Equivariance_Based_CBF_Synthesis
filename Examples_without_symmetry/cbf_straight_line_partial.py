"""
    ...
    Partial explicit computation of a CBF (based on explicit construction of a solution to the optimization problem).
    The obstacle under consideration is a
...
if __name__ == '__main__':
    ...
    # some parameters
    cbf_file_name = "cbf_straight_line_partial.json"
    ...
    # set domain bounds
    domain_lower_bound_partial = np.array([-25,0,-np.pi*1.3])
    domain_upper_bound_partial = np.array([25,0,0])
    discretization_partial = np.array([61,1,21])
    domain_lower_bound_partial_2 = np.array([-25,0,-np.pi*1.3])
    domain_upper_bound_partial_2 = np.array([25,0,np.pi*1.3])
    discretization_partial_2 = np.array([61,1,41])
    domain_lower_bound_complete = np.array([-25,-0.1,-np.pi*1.3])
    domain_upper_bound_complete = np.array([25,0.1,np.pi*1.3])
    discretization_complete = np.array([61,3,41])
